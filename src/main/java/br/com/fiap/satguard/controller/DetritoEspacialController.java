...
public class DetritoEspacialController {
    ...
    @GetMapping
    public ResponseEntity<Page<DetritoEspacial>> findAll(Pageable pageable) {
    ...
    @PostMapping
    public ResponseEntity<DetritoEspacial> create(@RequestBody @Valid DetritoEspacial entity) {
